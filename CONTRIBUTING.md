...
- Check the [Q&A](https://github.com/strvcom/strv-backend-go-time/discussions/categories/q-a) for a list of common questions and problems.
- Perform a search in [issues](https://github.com/strvcom/strv-backend-go-time/issues) and [discussions](https://github.com/strvcom/strv-backend-go-time/discussions) to see if the problem has already been reported. If it has and the issue/discussion is still open, add a comment to the existing issue/discussion instead of opening a new one.

#### How do I submit a bug report?w
Bugs are tracked as [GitHub issues](https://github.com/strvcom/strv-backend-go-time/issues).
Explain the problem and include additional details to help maintainers reproduce the problem:
- Use a clear and descriptive title for the issue to identify the problem.
- Describe the used environment:
  - What version of the `time` package and operating system are you using?
...
- Search the existing [issues](https://github.com/strvcom/strv-backend-go-time/issues) and [discussions](https://github.com/strvcom/strv-backend-go-time/discussions/categories/feature-requests) to see if the feature has already been suggested. If it has, add a comment to the existing issue/discussion instead of opening a new one.

#### How do I submit a feature request?
Planned features are tracked as [GitHub issues](https://github.com/strvcom/strv-backend-go-time/issues).
...
For example, if your commit adds a feature to the `time` package, you should use:

`feat(time): <brief feature description>`
